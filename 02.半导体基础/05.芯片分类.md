...
![MCU 内部架构示意图](assets/02.半导体基础/05.芯片分类/mcu_architecture.png)
...
![SoC 芯片架构示意图](assets/02.半导体基础/05.芯片分类/soc_architecture.png)
...
![FPGA 逻辑单元结构图](assets/02.半导体基础/05.芯片分类/fpga_cell.png)
